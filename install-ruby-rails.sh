...
if ! $SUDO_CMD apt install -y ruby-full build-essential libsqlite3-dev nodejs git curl gnupg libssl-dev libreadline-dev zlib1g-dev libgmp-dev libyaml-dev tzdata; then
